package gym.DbEngine;




import com.example.clientservererecepta.DbEngine.utils.EngineSettings;
import com.example.clientservererecepta.DbEngine.utils.TableMapper;
...
public class Engine {
    ...
    public Engine(){
        ...
        this.DBURL = "jdbc:postgresql://localhost:5432/";
        this.statement = new Statement();
        if (!doesDatabaseExist("gymWiki", "postgres", "admin", DBURL)) {
            createDatabase("gymWiki", "postgres", "admin", DBURL);
        }
        engineConnection = db.connectToDb("gymWiki", "postgres", "admin");
        engineSettings.setDbName("gymWiki");
    }
